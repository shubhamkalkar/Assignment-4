...
/*const ImageComponent =  ()=>{
    return(
      ...
      <img src="https://thumbs.dreamstime.com/b/teamwork-community-logo-design-vector-adoption-social-network-template-156215000.jpg" width="100" height="100" className="logo"/>
...
*/
/*const heading = React.createElement("h1",{className:"title"},"hello shubham"); 
const heading2 = React.createElement("h2",{className:"title"},"hello welcome"); 
const heading3 = React.createElement("h1",{className:"title"}," shubham bhau");      
...
/*const container = (
    <div>
        <h1 className="title">hello shubham</h1>
        <h2 className="title">hello welcome</h2>
        <h3 className="title">shubham bhau</h3>
    </div>
)
*/
...
const Title=()=>(
    <a href="/">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCz1kYTQH7CAVYluA9vI4oOQbbv3d-VyjRGGpYASg&s" alt="logo" className="logo"/>
    </a>
)
...
const Body=()=>{
    return(
       ...
       <RestaurantCard restaurant={RestrautList[0]} />
